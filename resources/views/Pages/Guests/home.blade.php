<x-app>
        ...
        <div class="carousel-inner">
            @foreach ($home_slider as $slider)
                <div class="carousel-item @if ($loop->index == 0) active @endif">
                    <img src="{{ $slider->getFirstMediaUrl('default') }}" class="d-block w-100"
                        alt="image">
                    <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                        <h5>{{ $slider->title }}</h5>
                        <p>{{ $slider->subtitle }}</p>
                    </div>
                </div>
    ...
    <div class="row mt-5 px-4 justify-content-center gap-3">
        <div class="col-sm-5 col-md-4 col-lg-3 card border-0">
            <div class="card-body text-center fw-bold fs-5">
                ...
                <p class="text-dark">Pelayanan Umum</p>
            </div>
        </div>
        <div class="col-sm-5 col-md-4 col-lg-3 card border-0">
            <div class="card-body text-center fw-bold fs-5">
                ...
                <p class="text-dark">Fasilitas Desa</p>
            </div>
        </div>
        <div class="col-sm-5 col-md-4 col-lg-3 card border-0">
            <div class="card-body text-center fw-bold fs-5">
                ...
                <p class="text-dark">Pembangunan Desa</p>
            </div>
        </div>
    </div>
    {{-- ---------------------------- Services End ------------------------------------ --}}
    ...
    <div class="section bg-light">
        <div class="container">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-6 text-sm-end"><a href="{{ route('guest-facility-index') }}" class="read-more">View All</a></div>
            </div>
